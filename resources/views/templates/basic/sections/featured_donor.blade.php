...
<section class="pt-100 pb-100 border-top  position-relative z-index-2 overflow-hidden">
    <div class="bottom-el-bg">
        <img class="lazyload" data-src="{{getImage('assets/images/frontend/featured_donor/'. @$donor->data_values->background_image, '1920x596')}}" src="{{getImage('assets/images/frontend/featured_donor/'. @$donor->data_values->background_image, '1920x596')}}" alt="@lang('image')">
    </div>
