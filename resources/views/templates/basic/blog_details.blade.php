	        ...
	        <div class="col-lg-8 col-md-8">
	            <div class="blog-details-wrapper">
	              	<div class="blog-details__thumb">
	                	<img class="lazyload" data-src="{{ getImage('assets/images/frontend/blog/'.$blog->data_values->blog_image,'626x430') }}" alt="@lang('Blog Image')">
	              	...
	              	<div class="widget">
                		...
                		<ul class="small-post-list">
			                @foreach($blogs as $post)
				                <li class="small-post">
				                    <div class="small-post__thumb"><img class="lazyload" data-src="{{ getImage('assets/images/frontend/blog/'. $post->data_values->blog_image,'626x430') }}" alt="@lang('Blog Image')"></div>
