                        ...
                        <div class="col-lg-6">
                            <div class="blog-post">
                                <div class="blog-post__thumb">
                                    <a href="{{ route('blog.details',[$blog->id,slug($blog->data_values->title)]) }}" class="d-block"><img class="lazyload" data-src="{{getImage('assets/images/frontend/blog/'. @$blog->data_values->blog_image, '728x465')}}" alt="@lang('image1')"></a>
                                </div>
