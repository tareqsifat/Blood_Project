            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('donor_login.send_auth_otp') }}" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        <label for="email">@lang('Enter phone number')</label>
                        <input type="text" name="mobile_number" class="form-control b-radius--capsule" id="username" value="{{ old('mobile_number') }}" placeholder="@lang('Enter phone number')">
