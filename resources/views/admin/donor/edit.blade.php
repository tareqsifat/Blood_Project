            		...
            		<div class="row">
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview" style="background-image: url(@if($donor->image == null)

                                                @if($donor->gender == 1) 
                                                {{getImage('assets/images/donor/male.jpg')}}
                        
                                                @else 
                                                {{getImage('assets/images/donor/femail.jpg')}}
                        
                                                @endif
                        
                                            @else
                                                
                                                {{getImage('assets/images/donor/'. $donor->image, imagePath()['donor']['size'])}}
                                            @endif)">
                		...
                		<div class="col-lg-8">
	                		<div class="form-group">
	                			...
	                			<input type="text" name="name" value="{{$donor->name}}" id="name" class="form-control form-control-lg" placeholder="@lang('Enter Full Name')" maxlength="80" >
	                		</div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                           <div class="form-group">
                                ...
                                <input type="text" id="phone" name="phone" value="{{$donor->phone}}" class="form-control form-control-lg" placeholder="@lang('Enter Phone')" maxlength="40" >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="email" name="email" value="{{$donor->email}}" class="form-control form-control-lg" placeholder="@lang('Enter Email')" maxlength="60" >
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                         <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="profession" id="profession" value="{{$donor->profession}}" class="form-control form-control-lg" placeholder="@lang('Enter Profession')" maxlength="80" >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="religion" name="religion" value="{{$donor->religion}}" class="form-control form-control-lg" placeholder="@lang('Enter Religion')" maxlength="40" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" value="{{$donor->address}}" class="form-control form-control-lg" placeholder="@lang('Enter Address')" maxlength="255" >
                            </div>
                        </div>
                         ...
                         <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="donate" name="donate" value="{{$donor->total_donate}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Blood Donate')">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="birth_date" id="birth_date" value="{{showDateTime($donor->birth_date, 'Y-m-d')}}" data-language="en" class="form-control form-control-lg datepicker-here" placeholder="@lang('Enter Date Of Birth')" >
                            </div>
                        </div>
